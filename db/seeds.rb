...
Product.create(name: "Moving Service & Starter Locker (5'x10')", description: "Starter unit about the size of an apartment closet. Perfect for a Marie Kondō disciple!", image_url: "/images/10x5.png", price: "55.00")
Product.create(name: "Moving Service & Medium Locker (10'x10')", description: "Medium unit for a single bedroom apartment's possessions. Urbanites, rejoice!", image_url: "/images/10x10.png", price: "110.00")
